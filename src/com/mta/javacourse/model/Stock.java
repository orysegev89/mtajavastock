...
public class Stock {
	...
	public Stock(Stock instance) {
		this(instance._symbol, instance._ask, instance._bid, new Date(
				instance._date.getTime()));
	}
	...
	public String getHtmlDescription() {
		String ret = "<br><b>Stock symbol: </b>" + _symbol + "<br><b>Ask: </b>"
				+ _ask + "<br><b>Bid: </b>" + _bid + "<br><b>Date: </b>" + getDate();
